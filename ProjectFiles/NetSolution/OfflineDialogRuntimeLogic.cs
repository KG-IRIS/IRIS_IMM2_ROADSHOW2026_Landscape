...
#endregion
/*
Fiix Gateway runtime UI script in turning asset offline panel to link offline reason list to model folder.
=============================================================
...
=============================================================
*/
public class OfflineDialogRuntimeLogic : BaseNetLogic
{
    ListBox eventList;
    public override void Start()
    {
        Folder eventFolder = Project.Current.Find<Folder>("AssetOfflineReasons");
